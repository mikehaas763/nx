...
/// <summary>
/// Everything target construction produces for one project.
/// </summary>
/// <remarks>
/// Target groups and the atomization flag cannot be returned as part of
/// <see cref="Target"/>: they are project-level facts that are only known once
/// every target has been built.
/// </remarks>
